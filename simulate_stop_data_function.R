simulate_stop_data <- function(num_pairs = 30, seed_val = 1) {
  set.seed(seed_val)
  
  # --- Route Scale Simulation ---
  # Reuses your existing route_occupancy function dynamically
  route_oc_small <- route_occupancy(num_pairs = num_pairs)
  
  # Generate standardized environmental covariates for N pairs
