...
hist(route_oc$N, breaks = 12, main="N Sites Distribution", xlab="Number of sites for sister pair", col="seagreen")
```
...
```{r}
hist(route_oc$m1, breaks = 12, main="Species Occupancy Sample", xlab="Number of occupied routes", col="darkgrey")
```
...
```{r}
hist(log(route_oc$m1), breaks = 12, main="Species Occupancy Sample", xlab="Number of occupied routes", col="darkgrey")
```
